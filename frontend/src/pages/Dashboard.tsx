...
export const Dashboard: React.FC = () => {
  ...
  const sources = [
    ['VDB market', status.vdb_loaded, status.vdb_count, 'Market benchmark'],
    ['Diamax inventory', status.diamax_loaded, status.diamax_count, 'Available stock'],
    ['Historical sales', status.sales_loaded, status.sales_count, 'Demand evidence'],
  ];
